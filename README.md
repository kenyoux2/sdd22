...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/Marukulaes/Manake-Hub/main/Library'))()
local Window = Library:CreateWindow({ Title =  ' Manake Hub - Moblie Script [ General Script ]', Center = true,  AutoShow = true, })
...
Library:SetWatermark('Manake Hub - Moblie Script | '..os.date('%A, %B %d %Y'))
