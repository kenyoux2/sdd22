...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Lindroxy Hub Free Script") then
			makefolder("Lindroxy Hub Free Script")
		end
		if not isfolder("Lindroxy Hub Free Script/Blox Fruits/") then
			makefolder("Lindroxy Hub Free Script/Blox Fruits/")
		end
		if not isfile("Lindroxy Hub Free Script/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Lindroxy Hub Free Script/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Lindroxy Hub Free Script/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Lindroxy Hub Free Script/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Lindroxy Hub Free Script/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Undetected Executor")
	end
